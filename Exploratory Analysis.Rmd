...
F18_GLM_quasi <- glm(Cover ~ Planting * Mowing.treatment * Mulch, family = quasibinomial, 
                   data = F2018)
summary(F18_GLM_quasi)
anova(F18_GLM_quasi, test = "Chisq")
...
G18_GLM_quasi <- glm(Cover ~ Planting * Mowing.treatment * Mulch, family = quasibinomial, 
                   data = G2018)
...
res_F17 <-resid(F_GLM_quasi)
hist(res, xlab = "Residuals", main = "")
plot(x = F2017$Cover, y = res, 
     xlab = "Cover", ylab = "Residuals")
plot(F2017$Planting, res, 
     xlab = "Planting", ylab = "Residuals")
plot(F2017$Mulch, res, 
     xlab = "Mulch", ylab = "Residuals")
plot(F2017$Mowing.treatment, res, 
     xlab = "Mowing treatment", ylab = "Residuals")
par(op)
...
avg_spread_18 <- guild_12_18 %>%
  group_by(Year, Plot, QuadLocation, Planted.guild, Category, Mowing.treatment) %>%
  summarise(nat.forb = mean(nat.forb),
            nat.grass = mean(nat.grass))
